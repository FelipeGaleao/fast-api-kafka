# Branching Model (Modelos de Ramificação)
...
O modelo de ramificação Github Flow trabalha basicamente com a branch main de longa duração e com branches de trabalho, que traduzem funcionalidades e alterações novas.
